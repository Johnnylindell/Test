...
def make_client(tmp_path: Path) -> TestClient:
    ...
    with database.transaction() as connection:
        ...
        connection.execute("CREATE TABLE admin_sessions(token_hash TEXT PRIMARY KEY,created_at TEXT,expires_at TEXT)")
...
def test_live_shell_and_shared_assets(tmp_path: Path) -> None:
    ...
    assert "Modulär parallellversion" in page.text
